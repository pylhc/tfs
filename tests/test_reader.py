...
class TestRead:
    ...
    def test_read_file_with_bool_in_header(self, _tfs_file_with_bool_in_header, _tfs_file_pathlib):
        df = read_tfs(_tfs_file_with_bool_in_header)
...
@pytest.fixture()
def _tfs_file_with_bool_in_header() -> pathlib.Path:
