...
latex_documents = [
    (master_doc, "tfs-pandas.tex", u"tfs-pandas Documentation", u"OMC-TEAM", "manual"),
]
...
man_pages = [(master_doc, "tfs-pandas", u"tfs-pandas Documentation", [author], 1)]
